# ABOUTME: Tests battle bag cancel behavior
# ABOUTME: Ensures canceling bag returns to battle menu
...
def test_battle_bag_cancel_returns_to_menu():
    game = StackGame()
    ...
    battle._handle_battle_menu_selection("ITEM")

    bag_state = game.state_stack[-1]
    bag_state.handle_input(StubInput("b"))
