...
class BagScreen:
    ...
    def render(self, renderer) -> None:
        ...
        for i in range(min(max_lines, len(visible_entries))):
            ...
            renderer.draw_text(name_text, 16, y)
    ...
    def _render_description(self, renderer, entries: list[BagEntry]) -> None:
        ...
        renderer.draw_rect((248, 248, 248), (0, box_y, GAME_WIDTH, 32), 0)
        renderer.draw_rect((0, 0, 0), (0, box_y, GAME_WIDTH, 32), 1)
        ...
        if text:
            renderer.draw_text(text, 8, box_y + 6)
